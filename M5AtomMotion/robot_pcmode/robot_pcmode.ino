...
static void parseData()
{
      ...
      switch(cmd){
        case 1: setMotorSpeed(getByte(0), getByte(1));; callOK(); break;
        case 2: setServoAngle(getByte(0), getByte(1));; callOK(); break;
        case 3: showLED(getShort(0),getShort(1),getShort(2));; callOK(); break;
        case 4: sendByte((_getSw(0))); break;
        #if defined(ESP32)
